...
Build a production-ready ServiceNow scoped application that comprehensive zurich-to-australia upgrade readiness scanner that audits script tables, properties, and ui artifacts for deprecated apis, removed tables, and breaking changes.. The application must be installable on any Australia-era ServiceNow instance and must pass automated functional tests with zero external runtime dependencies.
