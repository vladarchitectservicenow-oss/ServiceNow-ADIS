...
## Overview
ServiceNow-ADIS is a production-grade ServiceNow scoped application developed by Vladimir Kapustin under AGPL-3.0.

## Architecture
```mermaid
graph TD
    SN[ServiceNow Instance] -->|REST| ServiceNow-ADIS
    ServiceNow-ADIS -->|Store| DB[x_servicenow-adis_tables]
    ServiceNow-ADIS -->|Output| Report[Reports MD/JSON/CSV]
...
## Installation
```bash
git clone https://github.com/vladarchitectservicenow-oss/ServiceNow-ADIS.git
cd ServiceNow-ADIS
...
## ROI Analysis
| Metric | Manual Process | With ServiceNow-ADIS |
|--------|---------------|-------------|
...
# Run scan
POST /api/x_servicenow-adis/scan
...
See `Validation/TEST CASES/ServiceNow-ADIS/test_suite_SOP.md`
...
## Support
- GitHub Issues: https://github.com/vladarchitectservicenow-oss/ServiceNow-ADIS/issues
- ServiceNow Community: Tag `servicenow-adis`
